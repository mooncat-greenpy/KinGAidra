...
public class MainProvider extends ComponentProvider {
    ...
    public MainProvider(Program program, Plugin plugin, String owner,
        ...
        chat_panel = new ChatGUI(this, this.dockingTool, program, plugin, owner, srv, ghidra, container, ai, logger);
        main_panel.add("Chat", chat_panel);

        decom_panel = new DecomGUI(this, this.dockingTool, program, plugin, owner, srv, ghidra, ai, logger);
        ...
        keyfunc_panel = new KeyFuncGUI(this, this.dockingTool, program, plugin, owner, srv, ghidra, ai, logger);
